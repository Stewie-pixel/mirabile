      ...
      <div className="relative z-10">
        <div className="mb-8">
          <h2 className="text-2xl font-bold flex items-center gap-3" style={{ color: '#ffffff' }}>
            <div className="p-2 rounded-xl shadow-sm" style={{ background: 'linear-gradient(135deg, #0AFFE4 0%, #0EA5E9 100%)' }}>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg font-bold text-black text-xs" style={{ background: 'linear-gradient(135deg, #0AFFE4 0%, #0EA5E9 100%)' }}>
              1
            </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg font-bold text-black text-[10px]" style={{ background: 'linear-gradient(135deg, #0AFFE4 0%, #0EA5E9 100%)' }}>
              2a
            </div>
          ...
          <div className="pl-9 -mt-4 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              <div className="rounded-xl bg-white/5 border border-white/10 p-4 space-y-3 hover:border-[#0AFFE4]/30 transition-colors">
                <p className="text-sm font-medium text-white">Google Gemini <span className="text-xs text-[#0AFFE4] block mt-1">(Recommended)</span></p>
                <Button variant="outline" size="sm" asChild className="w-full bg-transparent border-[#0AFFE4]/20 hover:bg-[#0AFFE4]/10 hover:text-[#0AFFE4] transition-colors">
          ...
          <div className="space-y-2 pl-9 -mt-4">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <span className="w-20">Gemini:</span> <code className="bg-white/10 text-[#0AFFE4] px-2 py-1 rounded border border-[#0AFFE4]/20 text-xs">GEMINI_API_KEY</code>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <span className="w-20">OpenAI:</span> <code className="bg-white/10 text-[#0AFFE4] px-2 py-1 rounded border border-[#0AFFE4]/20 text-xs">LLM_API_KEY</code>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <span className="w-20">Claude:</span> <code className="bg-white/10 text-[#0AFFE4] px-2 py-1 rounded border border-[#0AFFE4]/20 text-xs">CLAUDE_API_KEY</code>
              </div>
            </div>
            <Button variant="outline" size="sm" asChild className="mt-4 bg-transparent border-[#0AFFE4]/20 hover:bg-[#0AFFE4]/10 hover:text-[#0AFFE4] transition-colors">
        ...
        <div className="mt-8 rounded-2xl p-4 flex gap-4 items-start" style={{ background: 'rgba(255, 255, 255, 0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
          <div className="p-2 rounded-xl shrink-0 shadow-sm" style={{ background: 'linear-gradient(135deg, #0AFFE4 0%, #0EA5E9 100%)' }}>
            <Info className="h-4 w-4 text-black" />
          </div>
          <div>
            <p className="text-sm font-medium text-white">Need Help?</p>
            <p className="text-sm text-muted-foreground mt-1">
              For detailed troubleshooting, refer to the <code className="bg-white/10 text-[#0AFFE4] px-2 py-0.5 rounded border border-[#0AFFE4]/20 text-xs">README.md</code> file in the project root directory.
            </p>
          </div>
        </div>
        ...
        {onDismiss && (
          <div className="flex justify-end mt-6">
            <Button className="bg-gradient-to-r from-[#0AFFE4] to-[#0EA5E9] text-black hover:opacity-90 font-semibold" size="sm" onClick={onDismiss}>
