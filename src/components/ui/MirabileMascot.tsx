  ...
  return (
    ...
    >
      ...
      >
        ...
        <circle cx="50" cy="25" r="7" fill="#0AFFE4" filter="url(#neon-glow)" />
        <circle cx="150" cy="25" r="7" fill="#0EA5E9" filter="url(#neon-glow)" />
        ...
        <rect
          ...
          strokeWidth="3.5"
          filter="drop-shadow(0px 8px 24px rgba(10, 255, 228, 0.15))"
        />
        ...
        <g style={{ animation: 'eye-pulse 2s ease-in-out infinite' }}>
          {/* Left Eye */}
          <ellipse cx="78" cy="100" rx="8" ry="8" fill="#0AFFE4" filter="url(#neon-glow)" />
          <ellipse cx="78" cy="100" rx="3" ry="3" fill="#FFFFFF" />
          {/* Right Eye */}
          <ellipse cx="122" cy="100" rx="8" ry="8" fill="#0EA5E9" filter="url(#neon-glow)" />
          <ellipse cx="122" cy="100" rx="3" ry="3" fill="#FFFFFF" />
        </g>

        {/* Cute Blushing Cheeks */}
        <circle cx="66" cy="115" r="4" fill="#0EA5E9" opacity="0.4" filter="blur(1px)" />
        <circle cx="134" cy="115" r="4" fill="#0EA5E9" opacity="0.4" filter="blur(1px)" />
        ...
        {/* Headphones Ear Cups */}
        <rect x="25" y="85" width="12" height="34" rx="6" fill="#0AFFE4" filter="url(#neon-glow)" />
        <rect x="163" y="85" width="12" height="34" rx="6" fill="#0EA5E9" filter="url(#neon-glow)" />
